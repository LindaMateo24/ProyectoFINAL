...
namespace ProyectoPrestamo.Modales
{
    public partial class mdCliente : Form
    {
        ...
        public string nombre { get; set; } = "Cliente";
        public mdCliente(string nombre = "")
        {
        ...
        private void mdCliente_Load_1(object sender, EventArgs e)
        {

        }

        private void mdCliente_Load_2(object sender, EventArgs e)
        {
