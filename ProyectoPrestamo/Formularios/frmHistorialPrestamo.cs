...
namespace ProyectoPrestamo.Formularios
{
    public partial class frmHistorialPrestamo : Form
    {
        ...
        public frmHistorialPrestamo(Usuario usuario)
        {
        ...
        private void btncancelar_Click(object sender, EventArgs e)
        {
            ...
            using (var form = new mdCancelarPrestamo(this.usuario))
            {
            ...
            if (index >= 0)
            {
                if (dgvdata.Columns[e.ColumnIndex].Name == "btnDescargar")
                {
                    if (dgvdata.Rows[index].Cells["Estado"].Value.ToString() != "PENDIENTE")
                    {
                        ...
                        MessageBox.Show("La descarga solo está habilitado para cuotas con estado \"PAGADO\"", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
